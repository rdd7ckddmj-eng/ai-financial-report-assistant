...
**2026-09-24 开发验收范围：** 非预置A股可按需获取最多六个年度的公开财务候选，
连接综合研究、年度趋势、五项年报金额对照、逐字段人工复核与本机研究案件。
公开源抽查覆盖60家公司；这不是全市场逐份年报验证。

本批8份新增候选的40项本期金额中，39项与公开源接近，中信2024营业收入差异对应2025年报明确重述；
保留原值及差异状态。连同原有5条资产负债说明，现有6条精确官方重述登记。

当前完整PDF回归共60份原件版本、45家公司：57份可生成待人工复核候选，3份明确未通过。
共59个公司/年度组合；洛阳钼业2025有两种不同原件版本，失败图像版与通过的繁体中国准则版分别计数。
财务快照新增“查看已测试的年报范围”，按公司列出年度、结果和官方原件，不用可搜索股票数冒充年报通过数。
保险范围包括人保2024、平安2023/2024、太保与新华2024/2025、国寿2024/2025；
证券包括华泰、招商和中信2024/2025，保留重述比较栏和负经营现金流。
本批还验证恒瑞、万华、上汽、中国核电、上海机场2025；紧凑附注“七76”仅在真实附注列头下读取。
原先51份原件的状态及两期金额全部不变，44家公司至少有一份通过的原件。
隆基2025的拆行负号现通过原PDF表格坐标定位，原始文字与程序连接结果分别展示和保存；
中国石油2024/2025使用四列负费用/负现金流出专用规则，每份保存52条双期金额检查。
此前46份候选的两期金额均未改变，未改写历史失败回执。
人保2025数值文字层、洛阳钼业2025原A股图像版、中国建筑2025图像三表仍保留待处理；
洛阳钼业另取得港交所完整繁体版，明确采用中国企业会计准则，独立通过三表检查。
本机OCR试验出现关键金额误读，未接入生产，也未用公开源或推算值补成候选。
紫金矿业原件超过手工上传32MiB上限，未计入这60份完整运行样本。
保险、证券、银行不套用普通公司比例；国寿2024比较期金融工具未重述，另停算自动同比。
上一批新增航运、通信、工程机械、地产、电力等行业样本，8份完整年报中5份通过、3份保留待处理；
5份新增候选的25项本期金额均与公开源接近，前42份的状态和两期金额不变。
汇川总资产390,000元差异与神华资产/负债两项差异，已在两源对照页面连接对应的后续官方重述报告、
调整前后金额及物理页码，并随研究案件原样保存。加上中国石油资产/负债两项，共5条资产负债证据精确匹配，不是全市场自动识别；
保留原年报值、差异状态与人工复核要求，新增真人确认数仍为0。
上一批3份新增候选的15项本期金额中，13项与公开源接近；中国石油2025的2项差异对应
2026半年报储气库同一控制合并的追溯调整，未自动替换原值或把差异改成一致。
普通企业利润表新增两期税前至税后、归母加少数股东损益的金额勾稽，绑定实际输出归母行，
核对年度列顺序、金额列完整性与来源边界；不声称收入成本全部分项已验证。
页面和HTML保留差额、单位、舍入规则，旧普通快照明确提示需重算。

详细范围及来源见 [保险模板说明](docs/INSURANCE_TEMPLATE_SCOPE.md)、
...
证券收入按发行人报表保留明确口径：中信使用营业收入，华泰、招商使用营业总收入；保险收入同样区分营业收入与营业总收入。人保2025当前数值文字层不可用，仍不生成金额候选。年报原披露与当前公开源重述值有差异时保留双值，具体范围与来源见本README开头链接及对应批次记录。
