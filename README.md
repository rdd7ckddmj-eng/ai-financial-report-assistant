...
当前完整PDF回归共19份、15家公司，均能生成待人工复核候选。
本批新增中国人保、中国太保、新华保险2024年三表模板，保留合并口径与原始页码；
中国平安已验证2023/2024年，银行及华泰证券等既有模板保持有效。
保险、证券、银行不套用普通公司比例；中国人寿及未验证的保险年度仍不支持专用提取。
金额对照相近不会自动确认数据，新增真人确认数为0。

详细范围及来源见 [保险模板说明](docs/INSURANCE_TEMPLATE_SCOPE.md) 和
