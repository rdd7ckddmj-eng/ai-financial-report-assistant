...
当前完整PDF回归共50份、38家公司：46份可生成待人工复核候选，4份明确未通过。
保险范围包括人保2024、平安2023/2024、太保与新华2024/2025、国寿2024/2025；
证券包括华泰与招商2024/2025，保留重述比较栏和负经营现金流。人保2025数值文字层不可用、
洛阳钼业2025财务表为图像、隆基2025负号拆行、中国石油2025费用/流出负值列式，均保留待处理，
不会用公开源或推算值补成候选。紫金矿业原件超过手工上传32MiB上限，未计入这50份完整运行样本。
保险、证券、银行不套用普通公司比例；国寿2024比较期金融工具未重述，另停算自动同比。
本轮新增航运、通信、工程机械、地产、电力等行业样本，8份完整年报中5份通过、3份保留待处理；
5份新增候选的25项本期金额均与公开源接近，前42份的状态和两期金额不变。
汇川总资产390,000元差异与神华资产/负债两项差异，已在两源对照页面连接对应的后续官方重述报告、
调整前后金额及物理页码，并随研究案件原样保存。仅3条已登记证据精确匹配，不是全市场自动识别；
