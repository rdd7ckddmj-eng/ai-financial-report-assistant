...
**2026-09-23 开发验收范围：** 非预置A股可按需获取最多六个年度的公开财务候选，
连接综合研究、年度趋势、五项年报金额对照、逐字段人工复核与本机研究案件。
公开源抽查覆盖60家公司；这不是全市场逐份年报验证。

当前完整PDF回归共35份、25家公司：34份可生成待人工复核候选，1份明确未支持。
...
本轮新增8家公司2025实测及招商两年模板，50项本期金额中49项与公开源接近，
汇川总资产390,000元差异保留待核实；新增真人确认数为0。
修复归母跨页取值、母公司串表、续表单位冲突及浏览器初始化重跑打断导航。
