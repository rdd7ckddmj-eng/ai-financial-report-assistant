...
@pytest.mark.parametrize('template',['insurance_unsupported_v1','securities_unsupported_v1','securities_group_parent_yuan_v1','insurance_signed_million_v1','insurance_picc_million_v1','insurance_cpic_million_v1','insurance_nci_four_column_v1','insurance_chinalife_million_v1'])
